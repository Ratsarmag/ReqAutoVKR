    ...
    with app.app_context():
        ...
        users = [
            ('admin', 'Admin123', 'Алексей', 'Петров',
             'Сергеевич', '71234567890', datetime(1990, 1, 1), 1),
            ('operator', 'Oper123', 'Мария', 'Иванова',
             'Алексеевна', '79876543210', datetime(1985, 5, 5), 2),
            ('mechanic1', 'Mech123', 'Дмитрий', 'Смирнов',
             'Игоревич', '71112223330', datetime(1980, 8, 8), 3),
            ('mechanic2', 'Mech456', 'Ольга', 'Кузнецова',
             'Викторовна', '74445556660', datetime(1975, 12, 12), 3),
            ('client1', 'Client123', 'Екатерина', 'Новикова',
             'Петровна', '77778889990', datetime(1995, 3, 3), 4),
            ('client2', 'Client456', 'Андрей', 'Морозов',
             'Иванов', '72223334440', datetime(2000, 7, 7), 4),
            ('client3', 'Client789', 'Анна', 'Соколова',
             'Алексеевна', '73334445550', datetime(1988, 11, 11), 4),
            ('client4', 'Client012', 'Сергей', 'Лебедев',
             'Владимирович', '74445556661', datetime(1992, 9, 9), 4),
            ('client5', 'Client345', 'Ирина', 'Захарова',
             'Сергеевна', '75556667770', datetime(1998, 4, 4), 4)
        ]
